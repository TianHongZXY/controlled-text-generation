...
class SST_Dataset:
    ...
    def __init__(self, emb_dim=50, mbsize=32):
        ...
        #     os.mkdir(cache)
        # vectors = Vectors(name='D:\\controlled-text-generation\\.vector_cache\\glove.840B.300d.txt', cache=cache)
        # self.TEXT.build_vocab(train, vectors=vectors)
        ...
        self.train_iter, self.val_iter, _ = data.BucketIterator.splits(
            (train, val, test), batch_size=mbsize, device='cpu',
